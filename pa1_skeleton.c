...
void run_server()
{
    ...
    // TODO: Server creates listening socket and epoll instance.
    ...
    // TODO: Server registers the listening socket to epoll
    printf("Server started on port %d. Now waiting for connections!\n", server_port);
